...
//定义WKUP按键的类型为GPIOA
#define     WKUP_GPIO_PIN_TYPE              GPIOA
...
//读取WKUP是否按下
#define     WKUP_STATUS                 ((HAL_GPIO_ReadPin(WKUP_GPIO_PIN_TYPE , WKUP_GPIO_PIN) == GPIO_PIN_SET) ? 1 : 0 )

//读取KEY0是否按下
#define     KEY0_STATUS                 ((HAL_GPIO_ReadPin(KEY0_GPIO_PIN_TYPE , KEY0_GPIO_PIN) == GPIO_PIN_SET) ? 1: 0 )      
