...
// ★ ① CS 引脚端口：GPIOB
#define NORFLASH_CS_GPIO_PIN_TYPE           GPIOB
...
#define NORFLASH_CS(x)                  do { (x) ?                                                                          \
                                            HAL_GPIO_WritePin(NORFLASH_CS_GPIO_PIN_TYPE, NORFLASH_CS_GPIO_PIN, GPIO_PIN_SET):   \
                                            HAL_GPIO_WritePin(NORFLASH_CS_GPIO_PIN_TYPE, NORFLASH_CS_GPIO_PIN, GPIO_PIN_RESET); \
                                        } while (0)
