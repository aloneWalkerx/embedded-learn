#ifndef __LCD_I_FONT_H
#define __LCD_I_FONT_H
...
/********************* 中文字体支持（16x16/24x24/32x32） *********************/

// 中文字体结构体定义
typedef struct {
    unsigned char Msk[32];   // 16x16 点阵数据，32字节
} typFNT_GB16;

typedef struct {
    unsigned char Msk[72];   // 24x24 点阵数据，72字节
} typFNT_GB24;

typedef struct {
    unsigned char Msk[128];  // 32x32 点阵数据，128字节
} typFNT_GB32;

// 16x16 中文字库（来自 oledfont.h，内容为“你好呀，小黑”）
...
// 具体数据定义（放在 .c 中会更好，但为了简单直接放在这里也可以）
// 注意：如果多个文件包含此头文件，需确保只定义一次，使用 static 或放在 .c 中。
// 我们为了演示，直接在这里定义，但为了不重复定义，加上 static。
static const typFNT_GB16 cfont16[] = {
...
{0x00,0x00,0x03,0xFC,0x78,0x10,0x49,0x10,0x49,0x10,0x49,0x10,0x4A,0x10,0x4B,0xFE,0x48,0x30,0x48,0x50,0x78,0x90,0x49,0x10,0x02,0x10,0x04,0x10,0x00,0x50,0x00,0x20},/*"呀",2*/
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x00,0x30,0x00,0x10,0x00,0x20,0x00,0x00,0x00},/*"，",3*/
{0x01,0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x11,0x10,0x11,0x08,0x11,0x04,0x21,0x04,0x21,0x02,0x41,0x02,0x81,0x02,0x01,0x00,0x01,0x00,0x05,0x00,0x02,0x00},/*"小",4*/
{0x00,0x00,0x3F,0xF8,0x21,0x08,0x29,0x28,0x25,0x48,0x3F,0xF8,0x01,0x00,0x01,0x00,0x3F,0xF8,0x01,0x00,0x01,0x00,0xFF,0xFE,0x00,0x00,0x48,0x88,0x44,0x44,0x84,0x44},/*"黑",5*/
{0x20,0x00,0x17,0xFC,0x00,0x04,0x42,0x04,0x41,0x04,0x5F,0xF4,0x41,0x04,0x41,0x04,0x4F,0xE4,0x49,0x24,0x49,0x24,0x49,0xA4,0x49,0x44,0x41,0x04,0x41,0x14,0x40,0x08},/*"闹",6*/
{0x10,0x20,0x10,0x20,0x3C,0x20,0x20,0x20,0x41,0xFC,0xBD,0x24,0x11,0x24,0x11,0x24,0xFD,0x24,0x11,0xFC,0x11,0x24,0x10,0x20,0x14,0x20,0x18,0x20,0x10,0x20,0x00,0x20},/*"钟",7*/

};

// 24x24 中文字库
static const typFNT_GB24 cfont24[] = {
{0x00,0x00,0x00,0x01,0x00,0x00,0x01,0x8C,0x00,0x03,0x0C,0x00,0x03,0x08,0x00,0x02,0x18,0x00,0x04,0x1F,0xFC,0x04,0x30,0x0C,0x0E,0x21,0x10,0x1C,0x41,0x00,0x14,0x41,0x00,0x24,0x91,0x00,0x44,0x19,0x20,0x04,0x11,0x10,0x04,0x31,0x18,0x04,0x21,0x0C,0x04,0x41,0x0C,0x04,0x41,0x06,0x04,0x81,0x04,0x05,0x01,0x00,0x04,0x11,0x00,0x06,0x0F,0x00,0x04,0x02,0x00,0x00,0x00,0x00},/*"你",0*/
{0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x00,0x00,0x06,0x00,0x00,0x06,0x1F,0xF8,0x04,0x00,0x18,0x04,0x00,0x20,0x7F,0xC0,0x40,0x0C,0x40,0x80,0x0C,0x40,0x80,0x08,0xC0,0x80,0x08,0x80,0x84,0x08,0xBF,0xFE,0x18,0x80,0x80,0x10,0x80,0x80,0x11,0x00,0x80,0x0D,0x00,0x80,0x03,0x80,0x80,0x02,0xC0,0x80,0x04,0x60,0x80,0x18,0x00,0x80,0x20,0x07,0x80,0x40,0x01,0x00,0x00,0x00,0x00},/*"好",1*/
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x3F,0xFC,0x3F,0x80,0x40,0x31,0x90,0x40,0x31,0x98,0x40,0x31,0x90,0x40,0x31,0x90,0x40,0x31,0xB0,0x40,0x31,0xFF,0xFC,0x31,0x81,0xC0,0x31,0x81,0x40,0x3F,0x83,0x40,0x31,0x86,0x40,0x31,0x04,0x40,0x20,0x08,0x40,0x00,0x10,0x40,0x00,0x20,0x40,0x00,0x40,0x40,0x00,0x84,0x40,0x03,0x03,0xC0,0x00,0x00,0x80,0x00,0x00,0x00},/*"呀",2*/
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x00,0x00,0x1C,0x00,0x00,0x1C,0x00,0x00,0x0C,0x00,0x00,0x08,0x00,0x00,0x08,0x00,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"，",3*/
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x00,0x00,0x18,0x00,0x00,0x08,0x00,0x00,0x08,0x00,0x00,0x08,0x00,0x00,0x08,0x00,0x01,0x09,0x00,0x01,0x88,0x80,0x03,0x08,0x40,0x02,0x08,0x20,0x06,0x08,0x38,0x0C,0x08,0x18,0x08,0x08,0x0C,0x10,0x08,0x0C,0x20,0x08,0x04,0x00,0x08,0x00,0x00,0x08,0x00,0x00,0x08,0x00,0x00,0x98,0x00,0x00,0x78,0x00,0x00,0x30,0x00,0x00,0x00,0x00},/*"小",4*/
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10,0x07,0xFF,0xF8,0x04,0x18,0x30,0x05,0x19,0xF0,0x04,0xD9,0x30,0x04,0xDA,0x30,0x04,0x5C,0x30,0x07,0xFF,0xF0,0x04,0x18,0x20,0x00,0x18,0x00,0x00,0x18,0x20,0x1F,0xFF,0xF0,0x00,0x18,0x00,0x00,0x18,0x08,0x3F,0xFF,0xFC,0x00,0x00,0x00,0x04,0x84,0x20,0x04,0x42,0x10,0x0C,0x63,0x18,0x08,0x63,0x08,0x18,0x42,0x08,0x00,0x00,0x00},/*"黑",5*/
{0x00,0x00,0x00,0x04,0x00,0x00,0x02,0x3F,0xF8,0x03,0x00,0x18,0x01,0x20,0x18,0x18,0x10,0x18,0x10,0x18,0x18,0x10,0x08,0x98,0x13,0xFF,0xD8,0x10,0x18,0x18,0x10,0x18,0x18,0x11,0xFF,0x98,0x11,0x18,0x98,0x11,0x18,0x98,0x11,0x18,0x98,0x11,0x18,0x98,0x11,0x1C,0x98,0x11,0x1B,0x98,0x10,0x18,0x18,0x10,0x18,0x18,0x10,0x18,0x18,0x10,0x00,0x70,0x10,0x00,0x10,0x00,0x00,0x00},/*"闹",6*/
{0x00,0x00,0x00,0x04,0x01,0x80,0x0C,0x00,0x80,0x0C,0x00,0x80,0x08,0x00,0x80,0x0F,0xE0,0x80,0x18,0x1F,0xFC,0x10,0x90,0x88,0x3F,0x90,0x88,0x24,0x10,0x88,0x44,0x10,0x88,0x04,0x10,0x88,0x04,0x10,0x88,0x7F,0xFF,0xF8,0x04,0x10,0x88,0x04,0x10,0x80,0x04,0x00,0x80,0x04,0x40,0x80,0x05,0x80,0x80,0x07,0x00,0x80,0x06,0x00,0x80,0x04,0x00,0x80,0x00,0x01,0x80,0x00,0x00,0x00},/*"钟",7*/
};

// 32x32 中文字库（只取“你好”两个）
static const typFNT_GB32 cfont32[] = {
{},/*"你",0*/
{},/*"好",1*/
{},/*"呀",2*/
...
0x07,0x00,0x00,0x00,0x0F,0x80,0x00,0x00,0x0F,0x80,0x00,0x00,0x07,0x80,0x00,0x00,0x01,0x80,0x00,0x00,0x03,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"，",3*/
{},/*"小",4*/
{},/*"黑",5*/
{},/*"闹",6*/
{},/*"钟",7*/
};
